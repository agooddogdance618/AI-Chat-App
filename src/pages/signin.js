    ...
    <div className='flex items-center bg-blue-700 justify-center h-screen'>
      <div className='flex flex-col m-5 md:m-0 grow bg-white border-4 border-gray-700 max-w-screen-sm rounded-xl p-5'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col items-center mb-5'>
            <input type='text' onChange={e => {setEmail(e.target.value)}} className='w-1/2 p-1 bg-white duration-500 delay-150 scale-100 hover:scale-110 focus:scale-110 outline outline-2 rounded outline-gray-500 hover:outline-black focus:outline-black mb-3' placeholder='Email'/>
            <input type='password' onChange={e => {setPassword(e.target.value)}} className='w-1/2 p-1 bg-white duration-500 delay-150 scale-100 hover:scale-110 focus:scale-110 outline outline-2 rounded outline-gray-500 hover:outline-black focus:outline-black mb-4' placeholder='Password'/>
